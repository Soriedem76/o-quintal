    ...
    <div style={styles.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div style={styles.modal}>
        ...
        <div style={styles.actions}>
          ...
          <button
            style={{ ...styles.postBtn, opacity: (!text.trim() || loading) ? 0.45 : 1 }}
            onClick={handlePost}
...
const styles = {
  ...
  pinNeedle: {
    ...
    background: 'var(--red)', borderRadius: '50% 50% 50% 0', transform: 'rotate(-45deg)',
  ...
  textarea: {
    ...
    border: '2px solid rgba(214,40,40,0.3)', padding: '12px',
    fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--white)',
    outline: 'none', resize: 'none', height: '90px', lineHeight: 1.5,
  },
  ...
  input: {
    background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(214,40,40,0.3)',
    padding: '8px 12px', fontFamily: 'var(--font-body)', fontSize: '12px',
    color: 'var(--white)', outline: 'none', width: '100%',
  },
  actions: { display: 'flex', gap: '10px' },
  cancelBtn: {
    flex: 1, background: 'transparent', border: '1px solid rgba(255,255,255,0.2)',
    color: 'var(--white)', fontFamily: 'var(--font-body)', fontSize: '11px',
    padding: '12px', cursor: 'pointer', letterSpacing: '1px',
  },
  postBtn: {
    flex: 2, background: 'var(--red)', border: 'none', color: 'var(--white)',
    fontFamily: 'var(--font-display)', fontSize: '16px', padding: '12px',
    cursor: 'pointer', letterSpacing: '1px', boxShadow: 'var(--shadow-brutal)',
